...
## SOEC MECSAI Vendor Monitoring & Two-Tier Instrumentation Doctrine (2026-02-09)

**Source:** VM_DELTA_SOEC_MECSAI_Vendor_Monitoring_20260209-1420.md
...
## Hermes Data Systems Network Architecture, Evergreen Compute & Federation Doctrine (2026-02-09)

**Source:** VM_DELTA_HDS-NET-HEBER_20260209-1430.md

[2026-02-09] Hermes Data Systems adopted an Evergreen Compute Refresh doctrine defining three asset life layers: 20+ year building infrastructure, 10-15 year plant equipment, and 3-5 year IT payload refresh cycles.

[2026-02-09] Hermes standardized vendor-agnostic rack slot envelopes (Slot S, Slot H, Slot X) defined by power, thermal, and interface constraints rather than silicon vendor.

[2026-02-09] Hermes formally prohibited dependency on chilled coolant and ammonia refrigerant inside compute buildings, enforcing warm-water liquid cooling with external heat exchange only.

[2026-02-09] Hermes adopted accelerator lane governance requiring single-silicon ecosystems per pod and prohibiting mixed accelerator lanes within a pod.

[2026-02-09] Hermes established a pod-group-level evergreen refresh model allowing rolling rack upgrades without building-wide downtime.

[2026-02-09] Hermes defined a dual Meet-Me Room (MMR-A/MMR-B) standard with physically diverse ingress routes as mandatory for all campuses.

[2026-02-09] Hermes adopted a network strategy to operate as its own network operator and private backbone, with a phased roadmap toward obtaining an autonomous system (ASN) and peering, while explicitly rejecting retail ISP operations.

[2026-02-09] Hermes defined a minimum campus carrier diversity requirement of three upstream providers with physical route and POP diversity verified by carrier route letters.

[2026-02-09] Hermes adopted ring-based inter-campus backbone topology as mandatory, explicitly prohibiting star topologies for federation traffic.

[2026-02-09] Hermes formalized an async-first federation doctrine for cross-campus workloads, reserving synchronous tightly coupled training to intra-campus or metro-scale deployments only.

[2026-02-09] Hermes approved Starlink enterprise connectivity as a tertiary, non-terrestrial communications leg limited to out-of-band management and emergency continuity, not tenant data plane traffic.
...
## Nuclear-SOEC Roadmap, Phase 3 Scaling & Topsoe Vendor Selection (2026-02-09)

**Source:** VM_DELTA_Nuclear_SOEC_Roadmap_20260209-1430.md

[2026-02-09] Decision: Initial hydrogen production backbone will use insured, warrantied, large-scale SOEC systems; experimental or internally developed SOEC hardware is prohibited from production loops.

[2026-02-09] Decision: Topsoe selected as front-runner SOEC vendor for Phase 1 due to availability of long-term service warranties and performance insurance.

[2026-02-09] Architecture Rule: Production operations and R&D systems must be physically, electrically, thermally, and contractually isolated.

[2026-02-09] Decision: Internal R&D division will be established to develop custom large-scale SOEC stacks for internal deployment and future external product sales.

[2026-02-09] Architecture Principle: Future refinery architecture is defined as power-paired by default; refineries without dedicated power generation are considered obsolete.

[2026-02-09] Decision: Nuclear reactor development will be pursued as a purpose-built design optimized for continuous SOEC operation, process heat delivery, and DC-first integration.

[2026-02-09] Architecture Principle: Reactor and SOEC systems will be co-designed to eliminate electric steam superheating via high-grade thermal integration.

[2026-02-09] Decision: Molten salt thermal loops are designated as the preferred temperature conditioning mechanism to achieve precise SOEC inlet steam-temperature control.

[2026-02-09] Constraint: Electric resistance heaters are disfavored for SOEC steam temperature elevation and should be eliminated where nuclear thermal conditioning is available.

[2026-02-09] Definition: Phase 3 production target formally defined as 100,000 barrels per day of synthetic hydrocarbon fuel equivalent.

[2026-02-09] Definition: Phase 3 hydrogen demand for 100,000 BPD synthetic hydrocarbon production is approximately 5,500 metric tons per day.

[2026-02-09] Architecture Rule: Planning-scale production unit defined as a paired block of approximately 1 GWe nuclear-electric output dedicated to SOEC.

[2026-02-09] Definition: One 1 GWe reactor-plus-SOEC block is expected to support approximately 12,000–13,000 BPD of synthetic hydrocarbon production.

[2026-02-09] Phase Impact: Achieving Phase 3 capacity of 100,000 BPD requires deployment of approximately eight 1 GWe reactor-plus-SOEC blocks.

[2026-02-09] Governance Rule: Internal technology graduation from R&D to production requires multi-year operational validation against insured baselines.

---

## SOEC Degradation Monitoring & MECSAI Warranty-Safe Sensor Doctrine (2026-02-09)

**Source:** VM_DELTA_SOECDegMonitoring_20260209-1335.md

[2026-02-09] MECSAI adopts a layered, warranty-safe equipment monitoring doctrine using non-invasive external sensors as the default outer layer.

[2026-02-09] Vendor integrations for SOEC and balance-of-plant systems are constrained to read-only data access with no write privileges.

[2026-02-09] External monitoring is prohibited from modifying vendor firmware, control logic, wiring harnesses, or pressure boundaries.

[2026-02-09] Clamp-on, adhesive, magnetic, infrared, acoustic, and external electrical sensors are defined as the approved monitoring boundary.

[2026-02-09] MECSAI normalizes all equipment telemetry into a unified tag schema with units, ranges, sampling rates, and criticality levels.

[2026-02-09] Degradation detection is formally defined to include thermal delta drift, specific energy creep, cell voltage dispersion, vibration spectral growth, and duty-cycle creep.
...
## Regulatory Library Architecture, Baseline Pinning & Three-Layer Control Model (2026-02-09)

**Source:** VM_DELTA_REGULATORY_LIBRARY_BUILD_20260209-1625.md

[2026-02-09] A compliance-first Regulatory and Compliance Library architecture was formally adopted, requiring regulation to lead engineering rather than post-design compliance remediation.

[2026-02-09] A governed regulatory repository root was fixed at Z:\SE_T1\REGULATORY as the sole authoritative source for engineering compliance inputs.

[2026-02-09] A mandatory directory taxonomy for regulatory materials was established, partitioned by NRC core, federal environmental, Arizona state, grid and pipeline, occupational safety, logistics, and datacenter/cyber domains.

[2026-02-09] A policy was established that engineering agents have read-only access to the regulatory library, with write authority restricted to governance and compliance roles.

[2026-02-09] A requirement was formalized that every regulatory document stored must include a machine-readable metadata sidecar containing provenance and integrity fields.

[2026-02-09] Paywalled standards bodies (NFPA, API, ASME, TIA, ASHRAE) were designated index-only, prohibiting storage of proprietary content while preserving authoritative references.

[2026-02-09] A remediation and certification process was approved to replace stub or partial CFR and NRC documents with full authoritative editions prior to engineering reliance.

[2026-02-09] A deterministic certification standard was defined requiring full-content verification, minimum page-count thresholds, checksum validation, and elimination of temporary artifacts.

[2026-02-09] A regulatory baseline pinning doctrine was adopted, requiring engineering to reference a fixed CFR edition while monitoring updates separately.
...
## RLM Harness Citation Fix & Validation Rules (2026-02-09)

**Source:** VM_DELTA_RLM_Harness_Citation_Fix_20260209-1415.md
...
## True RLM Architecture Rewrite & Harness Validation (2026-01-22 — 2026-01-24)

**Source:** VM_DELTA_HARNESS_RLM_TRUE_RLM_20260124-0410.md
...
## ATHENA/AEGIS Work-Order Workspace & Execution Protocol (2026-02-09)

**Source:** VM_DELTA_HCV-VM-EXTRACT-002_20260209-1600.md
...
## Phase 3 PFT Architecture & Refinery Design (2026-02-09)

**Source:** VM_DELTA_HCV-VM-EXTRACT-002_20260209-2243.md

[2026-02-09] The Phase 3 campus design formalizes a total of 12 Power-Fuels Trains (PFTs), each delivering 18,000 BPD, totaling ~100,000–108,000 BPD.

[2026-02-09] Each PFT is paired 1:1 with a Xe-100 High Temperature Gas-cooled Reactor (200 MWth), supplying a molten salt loop at 565°C.

[2026-02-09] Each PFT includes an AP1000 for 1.1 GWe electric generation, a SOEC stack producing 457 t/day H2 and ~3,650 t/day O2, and two 60 MW data centers.

[2026-02-09] CO₂ sourcing for the refinery process is locked to 90% DAC and 10% biomass with CO₂ buffer storage for 3–5 days of operation.

[2026-02-09] The DAC system uses waste heat from FT synthesis and data center cooling loops for sorbent regeneration; DAC electrical load is limited to air fans, vacuum pumps, and compression.

[2026-02-09] All major fired heaters and tail-gas turbines operate using oxy-combustion to simplify CO₂ capture and eliminate NOₓ formation.

[2026-02-09] Each PFT includes a 500 MWh BESS to stabilize power loads and respond to solar variance, alongside dedicated UPS systems per data center.

[2026-02-09] The refinery train consists of RWGS, Fischer-Tropsch, hydrocracking, and fractionation. Output per PFT is 12,000 bpd Diesel, 4,000 bpd Jet-A, 2,000 bpd LPG.

[2026-02-09] RWGS reactors operate at ~700°C; FT synthesis reactors operate at ~200°C; hydrocracking units operate at 350–400°C and >100 bar.

[2026-02-09] All O₂ from SOEC is routed for internal use (gasifier, combustors) or liquefied for sale; no venting permitted.

[2026-02-09] The refinery architecture mandates zero flaring; tail gas is recycled to FT or used in closed-loop combustion with full CO₂ recovery.

[2026-02-09] Total net electrical generation per PFT is ~1,282 MW; average load is ~1,196 MW, leaving ~86 MW export margin.

[2026-02-09] Each PFT occupies ~60–70 acres including process, SMR, BESS, and data center zones.

[2026-02-09] All PFTs are connected to a shared MVDC backbone with modular DC/DC converters; AC is used only for legacy and auxiliary subsystems.

[2026-02-09] Rev 3.0 of ASG-HC-REFINERY-001 is now the authoritative Volume VI companion document and supersedes all previous versions.

[2026-02-09] The Heber campus expands in phases: Phase 1 = 2 PFTs, Phase 2 = 4 PFTs, Phase 3 = 6 PFTs, up to 12 in Phase 5, with train layout spacing at 500 ft.

[2026-02-09] Water usage is minimized by recycling condensate from FT and RWGS back into the SOEC steam feed loop.

---

## EIS Strategy & Pre-Development Capital Sequencing (2026-02-09)

**Source:** VM_DELTA_HCV-VM-EXTRACT-002_20260209-2235.md

[2026-02-09] Full Environmental Impact Statement (EIS) is mandatory for the Heber Campus project due to nuclear scale, cumulative impacts, water withdrawal, and multi-agency federal action; avoiding an EIS is not a viable or defensible path.

[2026-02-09] Accepted strategy is a single Programmatic Master EIS covering ultimate buildout, with all phases and subprojects tiered beneath it; segmentation or EA-only approaches are explicitly rejected due to litigation and financing risk.

[2026-02-09] Target pre-development capital requirement to reach financeable Phase 1 construction readiness is approximately USD 8-10 million over 18-24 months.

[2026-02-09] Early-stage capital required for EIS launch and permitting must be development equity or equity-like instruments; straight debt is not feasible prior to permits, revenues, or offtake.

[2026-02-09] Government grants cannot fully fund early NEPA and EIS work; realistic grant offset is approximately 20-40 percent and is reimbursable, scoped, and sequenced after private capital commitment.

[2026-02-09] Correct capital sequencing is: development equity sponsors first, sovereign and federal lenders second, strategic offtake partners last; reversing this order materially increases project failure risk.

[2026-02-09] Engagement with nuclear vendors (e.g., reactor suppliers) may begin in parallel with NEPA and EIS execution via non-binding MOUs or slot-reservation frameworks; binding purchase orders are deferred until regulatory approvals and financing milestones.

[2026-02-09] Data center demand and hyperscaler interest function as later-stage credit enhancement and offtake leverage, not as early-stage lenders or development capital sources.

---

## Aegis RLM Operating Model & CAD Governance (2026-02-09)

**Source:** VM_DELTA_HCV-VM-EXTRACT-002_20260209-2230.md

[2026-02-09] Confirmed that Aegis is a Recursive Language Model (RLM) system based on the MIT RLM study, serving as the semantic orchestration spine for regulatory compliance rather than a standalone regulatory agent.

[2026-02-09] Formalized the operating model where Agent A (ChatGPT) functions as a Digital Twin and work-order author, Aegis performs recursive semantic decomposition and constraint propagation, and a 30+ SDK Agent Swarm executes engineering tasks with continuous compliance checks.

[2026-02-09] Locked program sequencing: Bible Rev 4.1 establishes architectural truth; Aegis RLM establishes semantic compliance truth; CAD execution (Onshape via Claude Code) implements physical geometry constrained by Aegis outputs; drawings and permit artifacts follow as evidence.

[2026-02-09] Accepted parallel execution model allowing Aegis RLM development and Onshape CAD learning to proceed concurrently, provided CAD work is confined to a SANDBOX classification with explicit prohibition on compliance claims or promotion.

[2026-02-09] Established mandatory separation between SANDBOX CAD artifacts and AUTHORITATIVE CAD artifacts, including directory segregation, naming prefixes, and work-order classification flags to prevent premature promotion.

[2026-02-09] Defined that CAD geometry may not claim regulatory compliance until Aegis emits constraint objects with IDs consumable by CAD work orders.

[2026-02-09] Locked that Claude Code acts as a deterministic operator executing explicit work orders only, with no interpretive authority over architecture or compliance.

[2026-02-09] Confirmed that ATB (Agent Technical Board) provides independent safety, compliance, and quality gate oversight with veto authority.

---

## Phase 0-A Activation Strategy & Corporate Formation (2026-02-10)

**Source:** VM_DELTA_HCV-VM-EXTRACT-002_20260210-2310.md

[2026-02-10] Decision established to pursue a staged Phase 0-A activation strategy to bridge from personal capital to institutional seed funding, explicitly deferring full Phase 0 execution until external partner capital is secured.

[2026-02-10] Phase 0-A scope formally constrained to: (1) Delaware C-Corp formation for Atlas Systems Group, (2) Arizona-based land targeting and nuclear envelope definition for BLM engagement, and (3) informal, non-filing intent briefings to NRC and DOE; all NEPA, ROW filing, and environmental field work explicitly deferred.

[2026-02-10] Phase 0-A personal capital envelope defined at approximately USD 30k–40k, intended solely to unlock strategic partners rather than complete regulatory activation.

[2026-02-10] Governance decision adopted to structure Atlas Systems Group as a Delaware C-Corp holding company, with project- and function-specific subsidiaries to be created later; Atlas Systems Group designated as the sole early-facing entity for BLM, NRC, DOE, and capital discussions.

[2026-02-10] Legal engagement strategy ratified requiring dual counsel: Delaware counsel for corporate formation, governance, cap table, and registered agent duties; Arizona counsel for land use, BLM interface, and state-level permitting alignment; single-firm consolidation explicitly rejected.
...
## Financing Readiness P&L Structure & Presentation Standards (2026-02-09)

**Source:** VM_DELTA_Financing_Readiness_PnL_20260209-2145.md

[2026-02-09] Adopted accounting rule: fuel production cost is defined as direct COGS only (~$65–70/bbl at steady state), with all campus overhead excluded from unit costs and reported as a single campus-level overhead line below contribution margin (Option A).

[2026-02-09] Formalized P&L structure for all phases: Revenue → Direct Costs (COGS by leg) → Contribution Margin → Campus Overhead (single line) → EBITDA → Debt Service → Net Cash Flow.

[2026-02-09] Approved consolidation of phase P&Ls into a single columnar P&L view (phases as columns) due to identical layout; individual per-phase tabs are not required for presentation.

[2026-02-09] Accepted data center phasing doctrine: Phase 1 = colocation only; Phase 2 = add AI/HPC data centers; Phases 3–6 = balanced addition of colocation and AI/HPC; AI silicon CAPEX included with a four-year refresh cycle.

[2026-02-09] Confirmed phase-scaled ancillary revenues: oxygen sales, calcium/mineral pellets (ramping to ~30 tpd at full build), and software licensing (MECSAI/Aegis) scale by phase and are additive; none are required for base project viability.

[2026-02-09] Integrated fuel economics requirement: include explicit fuel production cost ($/bbl direct COGS) and delivered fuel ($/gal) comparisons against 12-month trailing average market benchmarks (ULSD Gulf Coast, Jet Gulf Coast, Propane Mont Belvieu), with volatility ranges documented.
